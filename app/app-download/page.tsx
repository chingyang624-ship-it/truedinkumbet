...
export const metadata = {
  ...
  description: "Get the official Truedinkumbet App for iPhone and Android. Fast, secure, and virus-free. Download now to claim your exclusive App-only bonus!",
  keywords: "Truedinkumbet app download, Truedinkumbet APK, casino app Australia, betting app android, ios casino app, mobile casino login, Truedinkumbet mobile",
  ...
  openGraph: {
    ...
    description: "Play Slots & Live Casino on the go. Fast, Secure & Exclusive Mobile Bonuses.",
