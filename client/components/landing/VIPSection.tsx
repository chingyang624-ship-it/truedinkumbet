    ...
    <section className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">VIP Rewards and Perks</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
              VIP members enjoy exclusive access to personalized promotions, higher withdrawal limits, and faster
              processing times. Dedicated account managers are assigned to handle all VIP inquiries, providing tailored
