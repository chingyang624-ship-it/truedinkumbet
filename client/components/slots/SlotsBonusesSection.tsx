export default function SlotsBonusesSection() {
  return (
            ...
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  New members can claim up to 100% bonus on their first and second deposit—worth up to AUD 800.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              <span className="text-2xl font-bold text-blue-600 flex-shrink-0">•</span>
              <div>
                <p className="font-semibold text-gray-900 mb-2">Reload Bonuses</p>
                <p className="text-gray-600">
                  Frequent depositors enjoy daily reloads and free spins on selected slots.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              <span className="text-2xl font-bold text-blue-600 flex-shrink-0">•</span>
              <div>
                <p className="font-semibold text-gray-900 mb-2">VIP Cashback</p>
                <p className="text-gray-600">
                  High-rollers and loyal players can enjoy monthly cashback, birthday gifts, and exclusive support.
                </p>
              </div>
            </li>
          </ul>
