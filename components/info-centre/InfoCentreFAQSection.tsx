  ...
  const faqCategories: FAQCategory[] = [
      ...
      items: [
        {
          ...
          answer:
            "Truedinkumbet is a legitimate online casino operating globally. Our platform is fully licensed and regulated by the Government of Curacao under the Master Gaming License. We offer a state-of-the-art online casino experience with live dealer games, slot machines, sports betting, and much more. Players can enjoy thrilling online entertainment along with attractive promotions, rewards, and a comprehensive loyalty program.",
        },
        {
          question: "How can I open an account at Truedinkumbet?",
          answer:
            'Simply visit our website and click the "Join" button. Follow the on-screen instructions to create your account. The registration process is straightforward and quick.',
        },
        {
          ...
          answer: (
            <div>
              <p className="mb-4">
                Truedinkumbet accepts the following currencies for transactions:
              </p>
      ...
      items: [
        {
          ...
          answer: (
            <div>
              <p className="mb-4">
                Truedinkumbet has made it quick and easy to register a new
                account. On the homepage of the Truedinkumbet website, click the
                "Join" button at the top-right corner. You will be directed to
                the registration form where you need to provide:
              </p>
              <ul className="list-disc list-inside space-y-1">
                <li>
        ...
        },
        {
          ...
          answer: (
            <div>
              <p className="mb-4">
                Funding your account is simple. Truedinkumbet offers the
                following deposit methods:
              </p>
              <ul className="list-disc list-inside mb-4">
                <li>
                  Bank Transfer – Transfer funds from your bank account to your
                  Truedinkumbet account (a designated bank account will be
                  provided for local transfers).
                </li>
                <li>
                  E-Wallet Services – Use supported e-wallet options to deposit
                  funds.
                </li>
                <li>
                  Cryptocurrency – Bitcoin, Ethereum, and other supported
                  digital currencies.
                </li>
              </ul>
              <p>
                Truedinkumbet processes deposits quickly, ensuring that your
                funds are credited to your account as fast as possible. Please
                note that we do not accept deposits via cheque or bank draft.
                Bank transfer deposits are only available in certain countries.
                When you deposit via bank transfer, the funds will be added to
                your Main Wallet once our bank confirms receipt of the payment.
              </p>
            </div>
          ),
        },
      ...
      items: [
        {
          ...
          answer: (
            <div>
              <p className="mb-4">
                Truedinkumbet offers a wide range of gaming products to suit all
                types of players. The available options include:
              </p>
              <ul className="list-disc list-inside space-y-1">
                <li>Live Casino</li>
    ...
    },
    {
      ...
      items: [
          ...
          answer: (
            <div>
              ...
              <ul className="list-disc list-inside mb-4 space-y-1">
                ...
                <li>
                  <strong>Network Security</strong>: All servers are protected
                  by robust firewall systems to guard against data breaches and
                ...
                <li>
                  ...
                  transaction data) is securely transmitted and kept
                  confidential.
                </li>
              </ul>
              <p>
                These measures ensure that the Truedinkumbet platform is safe
                and that your data is well-protected at all times.
              </p>
            </div>
          ),
        },
        {
          question:
            "What are the system compatibility requirements for using Truedinkumbet?",
          answer:
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={`ml-4 flex-shrink-0 transition-transform ${isExpanded ? "rotate-180" : ""}`}
                      >
                        <svg
