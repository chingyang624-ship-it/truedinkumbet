  ...
  const games = [
    {
      ...
      image:
        "https://cdn.builder.io/api/v1/image/assets%2F4dfa7c46dbc1480caa7368c3233e05a7%2Fa8f1cc83c5244d7cae455de4ed405d3f",
    },
    {
      ...
      image:
        "https://cdn.builder.io/api/v1/image/assets%2F4dfa7c46dbc1480caa7368c3233e05a7%2Fde5161bfd0fc4f338c2c0d210b59a4b0",
    },
    {
      ...
      image:
        "https://cdn.builder.io/api/v1/image/assets%2F4dfa7c46dbc1480caa7368c3233e05a7%2Ffabb4e33fcaa4cb3b3a925b05678b630",
    },
    {
      ...
      image:
        "https://cdn.builder.io/api/v1/image/assets%2F4dfa7c46dbc1480caa7368c3233e05a7%2F2221ab5c90414553aa8d1dfcac5ce7b8",
      imageWidth: "80%",
      imageHeight: "400px",
    },
  ];
      ...
      >
        <div className="max-w-6xl mx-auto">
          <p style={{ color: "#7a7a7a", lineHeight: "1.8" }}>
            Truedinkumbet features a variety of high-quality fishing games to
            match every play style. Here are some of the most popular titles
            available now:
          </p>
        </div>
      </section>
          ...
          <div className="space-y-12">
            {games.map((game, index) => (
              <a
                ...
                style={{
                  gridAutoFlow: index % 2 === 1 ? "dense" : "initial",
                  cursor: "pointer",
                }}
              >
                ...
                <div style={{ order: index % 2 === 1 ? 1 : 2 }}>
                  ...
                  {index === games.length - 1 && (
                    ...
                    >
                      These titles represent the best of fishing game online
                      casino content, blending fast shooting action with
                      rewarding outcomes.
                    </p>
                  )}
                </div>
