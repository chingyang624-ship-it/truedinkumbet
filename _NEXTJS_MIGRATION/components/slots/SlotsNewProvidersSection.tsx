const providers = [
  ...
  },
  {
    name: "SA Gaming",
    description:
      "SA Gaming brings triple-A graphics and immersive sound effects to the table. Every slot feels premium, and it's clear why SA Gaming remains one of the top developers for both live and slot games.",
  },
  {
    name: "Playtech",
    description:
      "As one of the world's biggest software brands, Playtech continues to innovate with every release. Their omnichannel gaming experience means you can switch between desktop and mobile without losing progress — ideal for players on the go.",
  },
];

export default function SlotsNewProvidersSection() {
  return (
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center text-gray-900 mb-6">
          Top Online Slot Providers at Truedinkumbet
        </h2>
        ...
        <div className="mt-12 p-6 bg-white rounded-lg">
          <p className="text-center text-gray-600">
            All of these providers are available at Truedinkumbet, accessible with
            just a few clicks.
          </p>
        </div>
      </div>
