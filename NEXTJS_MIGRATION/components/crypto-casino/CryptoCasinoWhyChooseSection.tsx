  ...
  const reasons = [
    {
      ...
      description: 'Deposit with Bitcoin, Ethereum, and other cryptocurrencies. Funds arrive instantly to your account.',
    },
    {
      title: 'Fast Withdrawals',
      description: 'Withdraw your crypto winnings quickly and securely. No lengthy verification processes.',
    },
    {
      title: 'Complete Anonymity',
      description: 'Enjoy gaming privacy with blockchain-based transactions. No personal financial data required.',
    },
    {
      title: 'Lower Fees',
      description: 'Crypto transactions have minimal fees compared to traditional payment methods.',
    },
    {
