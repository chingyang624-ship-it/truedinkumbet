    ...
    <section className="py-20 px-4" style={{ backgroundColor: '#ffffff' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: '#1f2124', marginBottom: '24px' }}>
            Truedinkumbet: Best Live Casino Games Australia
          </h2>
          <div className="text-lg" style={{ color: '#6b7280', lineHeight: '1.8', maxWidth: '768px', margin: '0 auto' }}>
            <p className="mb-4">
