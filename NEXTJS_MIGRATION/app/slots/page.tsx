...
export const metadata = {
  ...
  description: 'Play thousands of slot games at Truedinkumbet. Win big with our premier online slots in Australia.',
}
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-16">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20">
          <h2 className="text-3xl font-bold mb-12" style={{ color: '#1f2124' }}>Featured Slots</h2>
